  ...
  lounge: {
    ...
    effects: [
      ...
      new Pizzicato.Effects.Convolver({
        impulse: '/mallplayer/aud/impulse1.wav', // http://www.openairlib.net/auralizationdb/content/underground-car-park
        mix: 1
      })
    ]
  }
...
app.play = function() {
  ...
  $('#btn-play').css('background-image', 'url(/mallplayer/img/pause.png)');
}
...
app.pause = function() {
  ...
  $('#btn-play').css('background-image', 'url(/mallplayer/img/play.png)');
}
...
$(function() {
  ...
  app.rainLoop = new Pizzicato.Sound({
    source: 'file',
    options: {
      path: '/mallplayer/aud/rain-loop.ogg',
      loop: true,
      volume: 0.1
    }
  }, function() {
